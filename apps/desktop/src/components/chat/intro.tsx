...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: `What should ${BRAND.productName} look at?`,
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} ${BRAND.productName} need to see?`,
    ...
    {
      headline: `What should ${label} ${BRAND.productName} tackle?`,
...
const WORDMARK = BRAND.wordmark || `${BRAND.productName} Agent`
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-5 w-[calc(100%-1rem)] font-['Michroma'] font-normal leading-[1.05] tracking-normal text-midground mix-blend-plus-lighter dark:text-foreground/90"
          style={{ '--fit-min': '2rem', '--fit-max': '5.5rem' } as CSSProperties}
        >
          <span>
            <span>{WORDMARK}</span>
          </span>
